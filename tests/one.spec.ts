...
test('has title', async ({ page }) => {
  await page.goto('https://www.w3schools.com/typescript/index.php/');

  // Expect a title "to contain" a substring.
  await expect(page).toHaveTitle(/TypeScript tutorial/);
});

test('TS Introduction  link', async ({ page }) => {
  await page.goto('https://www.w3schools.com/typescript/index.php/');
  ...
  await expect(page.getByRole('heading', { name: 'TS Introduction' })).toBeVisible();
});
